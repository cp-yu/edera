...
from stockimformation_core.errors import ConfigEditError, DagError
from stockimformation_core.config.git import config_write_lock
    ...
    def _validate(self, kind: ConfigKind, name: str, content: str) -> None:
        try:
            if kind == "system":
                ...
                from stockimformation_core.config.loader import _entity_refs
